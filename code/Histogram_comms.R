...
base_data<-read.csv("Received_power/Prx_Comms_C1.csv")

# Output file
pdf("Distance_Comm_C1.pdf", width = 7, height = 5)
...
# Output file
pdf("Prx_Comm_C1.pdf", width = 7, height = 5)
...
# Load database (DB)
base_data2<-read.csv("Received_power/Prx_Comms_C2.csv")

Dist_Com_2<- sqrt((base_data2$Distancia)^2 + (1.215)^2)

# Output file
pdf("Distance_Comm_C2.pdf", width = 7, height = 5)
...
# Output file
pdf("Prx_Comm_C2.pdf", width = 7, height = 5)
